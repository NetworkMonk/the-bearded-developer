...
export default function CookieBanner() {
  const exampleMarkup = `"use client";
...
FloatingBanner.propTypes = {
  ...
  return (
    <Card>
      <h3 className="text-2xl font-semibold">Cookie Consent Banner</h3>
      <p className="mt-2">
        This is a simple cookie consent banner that allows users to manage their
        cookie preferences.
      </p>
      <div className="my-4">
        <PreviewPanel markup={exampleMarkup}>
          <div className="flex justify-center my-10">
            <div className="bg-white shadow-lg border-2 border-black flex flex-col gap-4 p-4 max-w-xl">
              <div className="flex w-full items-center">
                <div className="flex-col flex gap-2">
                  <div className="font-bold text-xl text-gray-900">
                    We value your privacy
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:mx-0">
                <button className="flex-1 text-base font-semibold border-2 border-gray-800 text-black p-3 cursor-pointer bg-white hover:bg-gray-200 transition-colors duration-300">
                  Customise
                </button>
                <button className="flex-1 text-base font-semibold border-2 border-gray-800 text-black p-3 cursor-pointer bg-white hover:bg-gray-200 transition-colors duration-300">
                  Reject All
                </button>
                <button className="flex-1 text-base font-semibold border-2 border-gray-800 text-white p-3 cursor-pointer bg-black hover:bg-gray-800 transition-colors duration-300">
                  Accept All
                </button>
              </div>
            </div>
