...
export function Customise({ onSet, defaultValues }) {
  ...
  return (
    <Card>
      <h3 className="text-2xl font-semibold">Cookie Preferences</h3>
      <p className="mt-2">
        This is a simple cookie preferences component that allows users to
        manage their cookie settings. This can be used alongside cookie consent
        mode v2 with GTM.
      </p>
      <div className="my-4">
