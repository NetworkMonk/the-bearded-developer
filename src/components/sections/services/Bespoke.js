    ...
    <div id="bespoke" className="my-12">
      <div className="grid md:grid-cols-2 gap-4 w-full">
        <div className="md:order-1">
          ...
          <p className="my-2">
            If you have a specific requirement that can&apos;t be met with an
            off the shelf solution then a bespoke web application is the way to
            go. We&apos;re happy to discuss specific needs with you and make the
