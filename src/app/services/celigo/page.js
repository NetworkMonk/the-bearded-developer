...
const managedServiceTiers = [
  {
    ...
    icon: faBell,
    description:
      "Basic monitoring and support for stable integrations where only",
    features: [
      "Dedicated Slack channel.",
      "Daily/automated checks of key Celigo flows.",
      "Proactive alerting and first-line triage of errors.",
      'Quarterly "integration health" report.',
      "Next business day SLA response time for errors.",
      "Included: 4 hours development/month",
    ],
    ideal:
      "Small businesses with 1-3 simple flows that need basic monitoring and support.",
  },
  {
    name: "Standard Monitoring and Support",
    price: "£1,500/month",
    icon: faShield,
    ...
    features: [
      ...
      "4 hours SLA response time for errors.",
      "Liaison with Celigo support or other vendors where needed.",
      "Monthly call to review performance, errors, and optimisations.",
      "Included: 8 hours development/month",
    ],
    ideal: "Growing businesses with 4-10 flows and need faster response times.",
    popular: true,
  },
  {
    ...
    icon: faRocket,
    description:
      "Full integration lifecycle management with dedicated support.",
    features: [
      "Dedicated Slack channel",
      "Daily/automated checks of all Celigo flows.",
      "Proactive alerting and first-line triage of errors.",
      'Monthly "integration health" report.',
      "1 hour SLA response time for errors.",
      "Liaison with Celigo support or other vendors where needed.",
      "Monthly call to review performance, errors, and optimisations.",
      "Included: 20 hours development/month",
      "On call emergency support outside of business hours.",
    ],
    ideal:
      "Enterprise with 10+ complex flows and if you need response outside of business hours",
  },
];
